        ...
        <div class="w-full flex justify-center">
            <div class="container flex justify-center">
                ...
                <div class="bg-white text-left p-4 sm:p-6 lg:p-8 text-sm flex flex-col justify-center rounded-md shadow-md">
                    <div class="w-full flex justify-center">
                        <img class="h-10" src="../../assets/logoC.png" alt="logo">
                    </div>

                    <div class="py-4 md:py-6">
                        <p class="text-xl font-semibold">Welcome to Catch Lab</p>
                    ...
                    <Form class="w-full flex flex-col items-center" @submit="login" :validation-schema="schema">
                       ...
                       <button class="bg-primary hover:bg-secondary text-white rounded-md w-full py-2">LOGIN</button>
                   </Form>
                </div>
            </div>
        </div>
