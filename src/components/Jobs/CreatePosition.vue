    ...
    <div class="w-full flex flex-col bg-gray-100 screen-height">
        ...
        <div class="p-6 w-full">
            <div class="bg-white text-left p-6 rounded-lg shadow-md">
                <div class="pb-4">
                    <p class="text-xl font font-semibold pb-1">Create Job Position</p>
                </div>
...
export default {
    ...
    methods: {
        ...
        submit() {
            this.job_position.deadline = this.getDateTime(this.job_position.deadline);
            this.$store.dispatch('jobs/createJobPosition', {
                ...
                if(response.data.status == 200) { 
                    ...
                    this.job_position.title = ""
                    this.job_position.available_position = ""
                    this.job_position.is_active = ""
                    this.job_position.deadline = null
                    this.qualification.details = ""
                    this.job_description.type = ""
                    this.job_description.post = ""
                    this.job_description.location = ""
                    this.job_description.salary = ""
